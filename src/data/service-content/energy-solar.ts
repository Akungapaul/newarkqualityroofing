...
export const energySolarContent: ServiceContent[] = [
  ...
  // ─── 5. Silicone Elastomeric Roof Coating ─────────────────────────────────
  {
    ...
    approachContent: [
      ...
      'Detail areas including drains, scuppers, pipe boots, HVAC curbs, parapet walls, and rooftop equipment receive concentrated attention with additional coating layers and reinforcing fabric. These details are the most common leak points on any flat roof, and our protocol provides extra protection at each one. The completed system presents a seamless, brilliant white surface that reflects solar radiation, sheds water, and flexes with the building through every season.'
    ],
    residential: {
