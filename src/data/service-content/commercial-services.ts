  ...
  // ─── 2. Commercial Roof Repair ────────────────────────────────────────────
  {
    ...
    residential: {
      ...
      content: [
        ...
        'Our residential repair service brings the same responsiveness, documentation, and warranty performance that our commercial clients expect. Whether your home has a leaking flat roof section, damaged flashing, or persistent water intrusion that previous contractors could not resolve, our team has the diagnostic tools and repair expertise to fix it right.'
      ],
  ...
  // ─── 5. Infrared Roof Leak Detection ──────────────────────────────────────
  {
    ...
    residential: {
      ...
      content: [
        ...
        'Residential infrared detection can also identify areas of missing or inadequate insulation in your roof and attic, revealing energy loss pathways that increase your heating and cooling costs. This dual diagnostic capability makes infrared scanning a valuable tool for homeowners planning energy efficiency improvements as well as those dealing with active leaks.',
