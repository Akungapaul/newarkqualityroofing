...
export const millburnCedarShakeRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'How long will cedar shakes last on my Millburn property?',
      answer: 'Premium hand-split cedar shakes properly installed with adequate ventilation typically deliver thirty to forty years of service in Millburn\'s climate. Properties with heavy tree canopy may see shorter service life due to increased moisture exposure, while properties with good sun exposure and air circulation can achieve the upper end of that range. Regular maintenance -- debris removal, moss treatment, and periodic application of wood preservative -- significantly extends the functional lifespan of the installation.'
    },
    {
      question: 'Can you match new cedar shakes to my existing weathered roof for a partial replacement?',
      answer: 'New cedar shakes will initially appear lighter and more uniform than the weathered field, but they weather to a silver-gray tone that blends with the existing installation within two to three years of exposure. We can apply a pre-weathering stain to new shakes to reduce the initial color contrast, though some homeowners prefer to let the natural weathering process produce the blended appearance over time. The matching decision is discussed with the homeowner and architect before installation so expectations are calibrated.'
    },
    {
      question: 'Do cedar shakes attract insects or create pest problems?',
      answer: 'Untreated cedar heartwood contains natural oils -- thujic acid and thujaplicins -- that resist insect infestation, particularly termites and carpenter ants. However, shakes that have lost these oils through decades of weathering or that contain significant sapwood can become vulnerable. Pressure-treated shakes with borate-based preservatives add a secondary layer of insect resistance. We inspect the existing roof structure for any evidence of insect activity during our assessment and recommend treatment-grade material when conditions warrant additional protection.'
    },
    {
