...
export const millburnModifiedBitumenRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'Is torch-applied modified bitumen safe for installation near my Short Hills estate\'s wooded landscape?',
    ...
    {
      question: 'How does modified bitumen compare to single-ply membranes for durability?',
      answer: 'Modified bitumen\'s multi-layer construction provides superior puncture resistance and impact tolerance compared to single-ply TPO or EPDM membranes. The granulated cap sheet surface also provides inherent UV protection and foot-traffic resistance without supplemental coatings or walk pads. Service life is comparable -- twenty to twenty-five years for modified bitumen versus twenty-five to thirty for premium single-ply systems -- but modified bitumen\'s tolerance for the debris impacts and foot traffic common on Millburn properties can deliver practical advantages that outweigh the longer theoretical lifespan of single-ply alternatives.'
    },
    {
      question: 'Can modified bitumen be installed over an existing flat roof?',
      answer: 'In many cases, yes. If the existing roof deck and insulation are structurally sound and the existing membrane is well-adhered without moisture contamination, a modified bitumen overlay can be applied over the existing surface. This approach eliminates tear-off costs and reduces installation disruption. We verify overlay candidacy through core-sample analysis of the existing assembly, moisture testing to detect trapped water, and structural review to confirm the deck can support the additional weight of the new membrane layers.'
    },
    {
