...
export const millburnCedarShakeRoofReplacement: ComboContent = {
  ...
  faqs: [
    {
      question: 'Should I replace my cedar shakes with cedar or consider an alternative material?',
      answer: 'The decision depends on your priorities. Cedar replacement preserves the natural character the home was designed to express and maintains the material vocabulary that distinguishes the property. Composite cedar alternatives provide natural appearance without the fire-resistance and maintenance concerns. Architectural asphalt shingles offer the lowest maintenance at the lowest cost. We present the options with cost comparisons, maintenance-requirement summaries, and visual samples so you can make the decision that best aligns with your priorities for the property.'
    },
    {
      question: 'How long will new cedar shakes last on my Millburn property?',
      answer: 'With proper maintenance -- annual debris clearing, periodic moss treatment, and preservative application every five to seven years -- premium cedar shakes achieve thirty to forty years in Millburn\'s climate. Properties with heavy tree canopy creating extended shade may see shorter service life toward the lower end of that range due to accelerated biological decay. Properties with good sun exposure and air circulation achieve the upper end. The maintenance commitment is the most significant variable in cedar-shake longevity.'
    },
    {
      question: 'Do I need fire-retardant treated cedar shakes?',
      answer: 'Check with your insurance carrier and the Millburn Building Department for your specific property. Many carriers require Class A fire rating on roof materials in wooded areas, which untreated cedar does not achieve. Pressure-treated fire-retardant shakes meet Class A or B ratings while maintaining natural appearance. We specify the treatment level that satisfies both code requirements and insurance provisions for your property location.'
    },
    {
