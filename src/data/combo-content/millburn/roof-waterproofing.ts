...
export const millburnRoofWaterproofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'How much ice-and-water shield should be installed at the eaves on my Millburn home?',
      answer: 'Code requires coverage extending at least twenty-four inches past the interior face of the exterior wall. On Millburn estates where ice-dam history or steep-slope geometry creates elevated risk, we extend coverage to thirty-six inches or more past the wall line, and in severe-exposure locations -- north-facing slopes, areas beneath heavy canopy -- we may extend membrane coverage up to six feet from the eave. The additional coverage costs modestly more than the code minimum but provides substantially greater protection during the ice events that Millburn\'s elevation and tree canopy produce.'
    },
    {
      question: 'What waterproofing is needed beneath a rooftop terrace?',
      answer: 'Rooftop terrace waterproofing requires a dedicated membrane system -- not the same roof membrane that serves a non-trafficked surface. We specify hot-rubberized asphalt or reinforced liquid-applied waterproofing beneath terraces, with protection board and drainage mat between the membrane and the finished surface above. The membrane is flood-tested before any terrace surface is installed, and electronic leak-detection systems can be incorporated for premium installations where early breach detection is essential. These systems provide reliable waterproofing beneath pavers, tile, or wood decking for twenty-five or more years.'
    },
    {
      question: 'Can waterproofing solve a recurring leak that roof repair has not fixed?',
      answer: 'If the leak originates from a location where primary roofing materials are sound but secondary waterproofing is absent or inadequate, adding or upgrading waterproofing at the specific location can resolve the recurring issue. Common examples include ice-dam leaks where extended ice-and-water shield coverage prevents the water that penetrates the primary roof surface from reaching the interior, and wall-junction leaks where improved flashing waterproofing seals a path that wind-driven rain exploits. Our diagnostic process determines whether waterproofing upgrade or primary roof repair is the appropriate solution.'
    },
    {
