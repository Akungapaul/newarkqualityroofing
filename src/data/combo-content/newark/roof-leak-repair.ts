...
export const newarkRoofLeakRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'My Newark brownstone has a ceiling stain but I can\'t find where water is coming in from the attic. What\'s happening?',
      answer: 'Water in multi-story brownstones frequently travels significant distances from the entry point before becoming visible. The stain on your ceiling may result from water entering at the party wall junction two floors above, running along a joist, hitting a cross-member, and traveling laterally before dripping onto your ceiling plane. Our diagnostic approach traces the water path from the visible stain backward through the building structure using moisture meters and, when necessary, controlled water testing from the roof surface. In many Newark brownstones, we find that the entry point is on an entirely different section of the roof than the stain suggests.'
    },
    {
      question: 'Water leaks into my Ironbound commercial building only during heavy rain. Is this a roof problem or a wall problem?',
      answer: 'Heavy-rain-only leaks on commercial buildings often indicate a drainage capacity issue rather than a membrane failure. When rain intensity exceeds the drainage rate of your roof\'s interior drains or scuppers, water backs up and finds secondary paths -- over parapet caps, through wall-to-roof junctions, or into seam overlaps that are watertight under normal water levels but fail under ponding conditions. We diagnose this by inspecting drain capacity, checking for blockages in drain lines, and evaluating parapet overflow provisions. The repair may involve drain augmentation or parapet scupper installation rather than membrane work.'
    },
    {
      question: 'My neighbor\'s roof is causing leaks in my North Ward row house. Who is responsible for the repair?',
      answer: 'Party-wall leak responsibility in Newark row houses depends on where the water is entering the building envelope. If the leak originates at the junction between your neighbor\'s roof and the shared party wall, the repair work physically occurs on their side, but legal responsibility varies based on property boundaries and the nature of the shared wall. We provide diagnostic documentation that identifies the exact entry point with photographic evidence and moisture data -- documentation you can share with your neighbor, their insurance company, or if necessary, a mediator. In practice, most party-wall leak repairs in the North Ward are resolved cooperatively when both owners understand the technical facts.'
    },
    {
      question: 'How long does it take to find and fix a roof leak on a six-unit building in the Central Ward?',
      answer: 'Leak diagnosis on a multi-unit Newark building typically requires one full day for the diagnostic phase -- including interior inspection of affected units, roof surface evaluation, and water testing if needed. The repair itself depends on the cause: a straightforward flashing repair or membrane patch can be completed the following day, while more complex issues involving drainage modification or structural deck repair may take two to three days. We schedule interior access with tenants in advance and coordinate repair timing to minimize disruption to occupied units. Total timeline from first call to completed repair is typically five to eight business days, with emergency acceleration available for active severe leaks.'
    },
    {
