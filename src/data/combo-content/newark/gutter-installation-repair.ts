...
export const newarkGutterInstallationRepair: ComboContent = {
  ...
  conversionHooks: {
    midPageCta: 'Get your free gutter installation repair estimate in Newark — call now or fill out our form.',
