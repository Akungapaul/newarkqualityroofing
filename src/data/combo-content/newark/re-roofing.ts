...
export const newarkReRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'How do I know when my Newark building needs re-roofing versus more repairs?',
      answer: 'Several indicators suggest re-roofing is the right move: the roof is more than 20 years old, granule loss is widespread across the surface rather than isolated to damaged areas, multiple leaks have occurred in different locations over the past two years, shingles are curling or cracking across entire slopes, and repair costs are accumulating toward a significant percentage of replacement cost. We provide a cost-per-remaining-year analysis that compares continued repair against re-roofing investment, helping you see the breakeven point clearly.'
    },
    {
      question: 'What determines whether my re-roofing project uses tear-off or overlay?',
      answer: 'Four factors determine the method: existing layer count (overlay requires only one existing layer), deck condition (any rot or structural weakness requires tear-off), attic ventilation (inadequate ventilation favors tear-off for improvement access), and building load capacity (the structure must safely support double-layer weight for overlay). Our inspection evaluates all four and produces a clear recommendation. If your building qualifies for overlay, we present both options with cost and lifespan comparisons so you make an informed choice.'
    },
    {
      question: 'Does Newark require permits for re-roofing even if I am just overlaying?',
      answer: 'Yes. Newark requires a building permit for all re-roofing work regardless of method. Both tear-off replacement and overlay installation require permit application through the Department of Buildings and Code Enforcement, with inspections at the underlayment stage and upon completion. The permit ensures the work meets wind uplift standards, fire rating requirements, and structural adequacy for the chosen method. We handle the entire permit process as a standard part of every re-roofing project.'
    },
    {
      question: 'Can you re-roof my building in winter or does work stop during cold months?',
      answer: 'Re-roofing in Newark continues through winter with appropriate precautions. Asphalt shingles require hand-sealing of tabs when installed below 40 degrees Fahrenheit because the adhesive strips do not activate in cold temperatures. We schedule winter re-roofing during forecast windows above 35 degrees and use hand-sealing methods on all tabs. Material storage is managed to prevent shingle brittleness from extreme cold. Some projects are better scheduled for spring if timing permits, but emergency re-roofing and buildings with active damage proceed year-round.'
    },
    {
