...
export const newarkSlateRoofReplacement: ComboContent = {
  ...
  faqs: [
    {
      question: 'Should I replace my Newark historic home\'s slate roof with natural slate or synthetic alternatives?',
      answer: 'The decision depends on three factors: historic designation status, structural capacity, and budget. If your Forest Hill or North Ward property is on the Newark historic register or within a historic district, natural slate may be required to maintain compliance. If the framing shows signs of fatigue, synthetic slate at sixty percent less weight may be the safer choice. Budget-wise, natural slate replacement typically costs three to four times more than synthetic but carries a lifespan two to three times longer. We provide detailed comparisons for each Newark property we assess.'
    },
    {
      question: 'How much of my existing Newark slate roof can be salvaged during replacement?',
      answer: 'On a typical hundred-year-old Newark slate roof in fair condition, we recover thirty to forty percent of tiles in reusable condition. The actual yield depends on the original slate variety -- hard Pennsylvania black slate salvages better than softer Vermont varieties -- and the care taken during removal. Salvaged slate has real value: it can reduce the material cost of your replacement by using recovered tiles in less visible roof areas, and surplus tiles provide an inventory for future spot repairs that would otherwise require costly material matching.'
    },
    {
      question: 'Does my Newark home need structural reinforcement before a new slate roof can be installed?',
      answer: 'Approximately half of the natural slate replacements we perform in Newark require some level of structural reinforcement. After a century of carrying 800 to 1,500 pounds per square, original rafters and joists show compression at bearing points and deflection across spans. Our structural engineering partner evaluates each property and specifies reinforcement only where needed -- sistering rafters, adding collar ties, or upgrading bearing connections. Synthetic slate at forty percent less weight often eliminates the reinforcement requirement entirely, which is one of its strongest arguments for older Newark structures.'
    },
    {
      question: 'How long will a new slate roof last on my Newark property?',
      answer: 'Natural slate from quality quarries carries an expected lifespan of 100 to 150 years on a properly detailed Newark installation. The slate tiles themselves may outlast every other component -- copper flashings last 70 to 100 years, and underlayment needs replacement at the 40 to 60 year mark. Premium synthetic slate products carry 50-year warranties, though the material has not existed long enough to verify actual lifespans in Newark\'s climate. In either case, a slate roof installed today will serve the next several generations of the property.'
    },
    {
