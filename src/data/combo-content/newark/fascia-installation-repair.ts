...
export const newarkFasciaInstallationRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'Should I replace my Newark brownstone\'s wood fascia with PVC or aluminum?',
      answer: 'It depends on the building\'s architectural significance and your maintenance tolerance. For mid-century homes in Vailsburg or Weequahic with simple flat fascia profiles, cellular PVC is an excellent choice -- it won\'t rot, never needs painting, and costs less than wood over its lifecycle. For Victorian brownstones in Forest Hill or the North Ward with ornate fascia profiles, PVC cannot replicate the detail convincingly and is not appropriate for buildings with historic character. Our preferred approach for these homes is rot-resistant wood fascia wrapped with aluminum coil stock -- this preserves the visual profile while providing the moisture protection that bare wood lacks in Newark\'s climate.'
    },
    {
      question: 'How do I know if my fascia needs repair or just repainting?',
      answer: 'Push firmly on the fascia board with your thumb at several points, particularly near the gutter brackets and at the rafter tail locations behind the board. If the wood gives or feels spongy, it\'s rotted and needs replacement, not paint. Other indicators of structural fascia failure include gutter sections that have pulled away from the building, visible gaps between the fascia and soffit panels, or paint that peels repeatedly despite proper preparation. If your fascia is solid but the paint is failing, a quality scrape-and-repaint can extend its life another eight to ten years -- but only if you also address whatever water management issue is causing accelerated paint failure.'
    },
    {
      question: 'Can you match the decorative fascia profile on my historic Newark home?',
      answer: 'Yes. We template the existing profile before removal and have it replicated by specialty millwork shops experienced in historic profile replication. The new fascia is milled from rot-resistant wood species -- typically Spanish cedar or clear western red cedar -- that hold detail comparably to the original old-growth lumber. For partial replacements where only a section of fascia has failed, we match the profile precisely to blend with the remaining original material. The cost premium for custom-milled profiles over standard flat fascia is typically thirty to forty percent, but it preserves the architectural character that gives Newark\'s historic brownstones their value.'
    },
    {
      question: 'Why does my fascia keep rotting even after I replaced it five years ago?',
      answer: 'Recurring fascia rot means the water source that caused the original failure was never corrected. The most common culprits in Newark are undersized gutters that overflow behind the fascia during heavy rain, missing or improperly installed drip edges that allow roof water to run down the back face of the fascia board, and clogged gutters from the city\'s heavy tree canopy that create standing water at the fascia line for extended periods. Our fascia replacement protocol addresses all three conditions as part of the project -- we won\'t install new fascia without also correcting the water management deficiency that will destroy it again.'
    },
    {
      question: 'How much does fascia installation repair cost in Newark, NJ?',
      answer: 'Most fascia installation repair projects in Newark range from $1,200–$3,500. Your exact cost depends on roof size, materials, and project complexity. We provide free, detailed written estimates with no obligation — call us today to schedule yours.',
    },
  ],
  metaDescription: 'Fascia installation and repair in Newark NJ -- historic profile matching, aluminum wrapping, rafter tail repair on brownstones and row houses.',
  pricing: {
    range: '$1,200–$3,500',
  ...
  conversionHooks: {
    midPageCta: 'Get your free fascia installation repair estimate in Newark — call now or fill out our form.',
