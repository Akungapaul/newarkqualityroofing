...
export const newarkEmergencyRoofRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'What is your average response time for a roof emergency in Newark?',
      answer: 'During business hours, we typically arrive at a Newark address within 90 minutes to two hours of a confirmed emergency dispatch. After-hours and weekend calls are handled by our on-call crew and generally see arrival within two to three hours depending on location and weather conditions. During major storm events that produce high call volume, we operate a triage system -- active water entry threatening occupied spaces receives priority over damage that is not currently admitting water. We provide an estimated arrival time at the point of dispatch so you can plan accordingly.'
    },
    {
      question: 'How much does an emergency roof repair cost compared to a standard repair in Newark?',
      answer: 'Emergency service carries a dispatch fee that covers after-hours crew mobilization, and temporary materials are billed at standard rates. The total cost for a typical emergency tarp-and-secure visit on a Newark residential property ranges from $500 to $1,500 depending on the severity and access complexity. This emergency cost is applied as a credit toward the permanent repair when you proceed with us -- so you are not paying twice for the same damage. We provide a permanent repair estimate within 48 hours of the emergency visit, giving you a complete picture before any further commitment.'
    },
    {
      question: 'Can you respond to a commercial roof emergency in the Ironbound at night?',
      answer: 'Yes. Our after-hours crew covers all of Newark including the Ironbound commercial district. Night responses in the Ironbound actually benefit from reduced traffic and easier equipment staging on streets that are congested during business hours. We coordinate with building owners or property managers for interior access and carry portable lighting systems for rooftop work. Commercial flat-roof emergencies in the Ironbound are among our most frequent after-hours calls, and our crews are experienced with the membrane systems, parapet configurations, and HVAC penetration layouts common in that district.'
    },
    {
      question: 'A tree fell on my roof in Vailsburg during a storm. What should I do first?',
      answer: 'First, ensure all occupants are safe and evacuate any rooms directly beneath the damage. If you see downed power lines near or on the tree, call PSE&G immediately and do not approach the area. Then call us for emergency response. Do not attempt to remove the tree yourself -- partial removal can shift the weight and cause additional structural collapse. Our crew will assess structural safety, stabilize the tree to prevent further movement, install temporary weatherproofing around the penetration point, and coordinate with a tree removal service. Document everything with photos for your insurance claim before any cleanup begins.'
    },
    {
