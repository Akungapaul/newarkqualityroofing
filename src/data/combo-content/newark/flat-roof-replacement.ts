...
export const newarkFlatRoofReplacement: ComboContent = {
  ...
  faqs: [
    {
      ...
      answer: 'TPO and PVC are the two leading membrane choices for Newark commercial flat roof replacement. TPO offers the best value with strong heat-weld seams, energy-efficient white reflectivity, and competitive pricing. PVC provides superior chemical resistance -- important for Newark buildings near industrial operations or restaurants with grease-laden exhaust. Both carry twenty to thirty year manufacturer warranties when installed by certified contractors. We recommend TPO for most Newark office and retail buildings and PVC for food service, industrial, and chemical-exposure environments.'
    },
    {
      question: 'How long does a commercial flat roof replacement take in Newark?',
      answer: 'Timeline depends on roof size and complexity. A 5,000-square-foot commercial roof with moderate equipment typically completes in five to seven working days. A 20,000-square-foot building with extensive rooftop HVAC may require three to four weeks of phased work. The phased approach allows sections of the building to remain operational while adjacent sections are under construction. Weather is a significant variable -- flat roof membrane cannot be installed in rain or on wet substrates, so we build weather contingency days into every Newark project schedule.'
    },
    {
      question: 'Does Newark require tapered insulation on flat roof replacements?',
      answer: 'New Jersey building code requires positive drainage on all commercial flat roof replacements, and tapered insulation is the standard method for achieving this on buildings with level structural decks. The code also requires minimum R-30 insulation on commercial roof replacements, which tapered insulation satisfies. The combination of drainage slope and insulation value in a single system makes tapered insulation the default specification for virtually every Newark commercial flat roof replacement. The additional material cost is offset by energy savings and the elimination of ponding-related warranty exclusions.'
    },
    {
      question: 'Can my Newark building stay open during a flat roof replacement?',
      answer: 'Yes, and maintaining business continuity is a core element of our project planning for Newark commercial buildings. We divide the roof into sections and complete each to full weathertight condition before opening the next. Interior-sensitive areas like server rooms, medical facilities, or inventory storage are prioritized for early completion. Noise-sensitive operations like offices or classrooms can be scheduled for weekend tear-off phases. The key is advance coordination -- we develop a phased plan specific to your building\'s operations before the first day of construction.'
    },
    {
