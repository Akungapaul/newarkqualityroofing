...
export const newarkRoofReplacement: ComboContent = {
  ...
  faqs: [
    {
      question: 'How do you handle dumpster placement for a roof replacement on a narrow Newark street?',
      answer: 'We apply for a temporary street-use permit from the Newark Department of Engineering, which allows us to place a roll-off dumpster in the street for the duration of the project, typically three to five days. We coordinate delivery timing to avoid rush-hour conflicts and post no-parking signs 48 hours in advance per city requirements. On streets too narrow for dumpster placement, we use rooftop conveyor systems to direct debris into containers positioned on adjacent lots or in rear alleyways. We never block fire lanes or hydrants regardless of the access situation.'
    },
    {
      question: 'My Newark brownstone has multiple layers of old roofing. Does everything come off?',
      answer: 'Yes. Newark building code and manufacturer warranty requirements both mandate a complete tear-off to the roof deck for a proper replacement. On older brownstones in Forest Hill and the North Ward, we frequently find two, three, or even four layers dating back decades. Removing all layers lets us inspect the deck sheathing for rot, verify structural integrity, and install modern underlayment systems directly to a clean surface. The added cost of full tear-off is recovered through longer roof life and valid warranty coverage -- a critical consideration given how aggressively Newark\'s climate tests roofing materials.'
    },
    {
      question: 'Will my neighbors be affected during the roof replacement on my North Ward row house?',
      answer: 'We notify adjacent property owners at least one week before the project begins. On attached row houses, the party wall junction will be temporarily exposed during tear-off, and we install weatherproof coverings to protect the neighboring roof edge. There will be noise from tear-off and installation equipment during working hours, typically 7:30 AM to 5:00 PM per Newark noise ordinance. Debris containment systems prevent material from reaching neighboring properties. If scaffolding placement requires access to a neighbor\'s property line, we arrange that permission during the pre-construction phase.'
    },
    {
      question: 'What permits does Newark require for a residential roof replacement?',
      answer: 'A full roof replacement in Newark requires a building permit from the Department of Buildings and Code Enforcement. We submit the application with project specifications including material type, wind uplift ratings, and structural details. The permit process typically takes five to ten business days. Inspections are required at the underlayment stage and upon completion. For buildings built before 1978, lead paint disturbance protocols may apply if painted surfaces are disturbed during the work. We handle all permit applications, fees, and inspection scheduling as part of our standard service.'
    },
    {
