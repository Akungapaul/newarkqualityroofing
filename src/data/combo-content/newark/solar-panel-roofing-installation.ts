...
export const newarkSolarPanelRoofingInstallation: ComboContent = {
  ...
  faqs: [
    {
      question: 'How much can I earn from SREC-II certificates on my Newark solar installation?',
