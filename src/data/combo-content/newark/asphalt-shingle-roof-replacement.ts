...
export const newarkAsphaltShingleRoofReplacement: ComboContent = {
  ...
  faqs: [
    {
      question: 'How long does a full asphalt shingle tear-off and replacement take on a Newark row house?',
      answer: 'Most Newark row houses with standard rectangular footprints complete in two to three days. Day one covers tear-off, deck inspection, and repairs. Day two is underlayment and shingle installation. Day three handles detailing, flashing, and cleanup. Larger brownstones with complex rooflines or extensive decking damage may extend to four days. We schedule consecutive working days and maintain weather protection between phases so the building is never left exposed overnight without at least underlayment coverage.'
    },
    {
      question: 'Should I upgrade from 3-tab to architectural shingles during my Newark roof replacement?',
      answer: 'We strongly recommend the upgrade for Newark properties. The cost difference is roughly fifteen to twenty percent of the total project, but the return is substantial: architectural shingles carry 50-year limited warranties versus 25-year for 3-tab, withstand 130-mph winds versus 60-mph, and resist the thermal cycling that Newark\'s urban heat island imposes. The dimensional appearance also improves curb appeal on Newark\'s historic housing stock -- a flat 3-tab roof looks dated against the ornamental brickwork common in the North Ward and Forest Hill.'
    },
    {
      question: 'What happens if the deck beneath my shingles is rotted when you tear off the old roof?',
      answer: 'Deck damage is common on Newark roofs, especially brownstones with poor attic ventilation. We include a per-sheet contingency price in every estimate so there are no surprise charges on tear-off day. Our crew replaces damaged sections with CDX plywood matched to the existing deck thickness, ensuring a flat nailing surface for the new shingles. If damage exceeds twenty percent of the total deck area, we contact you before proceeding to discuss whether full re-decking makes more economic sense than patchwork replacement.'
    },
    {
      question: 'How do you coordinate with my neighbor when replacing shingles on an attached Newark brownstone?',
      answer: 'We notify adjacent property owners in writing at least one week before the project, explaining the scope, timeline, and any temporary measures that will affect their roofline. During tear-off, we install temporary waterproof barriers at the party wall to protect their existing roof system. If their flashing or edge condition is deteriorated, we document it and provide them a separate repair estimate. This neighbor coordination is standard practice for every attached-building project we perform in Newark -- it protects both properties and prevents post-project disputes.'
    },
    {
