...
export const newarkFullRoofTearOff: ComboContent = {
  ...
  faqs: [
    {
      question: 'Why is full tear-off recommended instead of overlay for my Newark home?',
      answer: 'Newark building code permits overlay only when a single layer of existing roofing is present and the deck structure is confirmed sound. Beyond code requirements, tear-off is recommended because it exposes the deck for inspection -- critical in Newark\'s older housing stock where hidden rot, inadequate ventilation, and structural modifications are common. Tear-off also eliminates trapped moisture between layers, which accelerates deterioration in Newark\'s humid climate. The added cost of tear-off typically runs $1,500 to $3,000 more than overlay on a standard residential building, but the extended roof life and valid manufacturer warranty make it the better long-term investment.'
    },
    {
      question: 'How do you manage debris on narrow Newark streets during tear-off?',
      answer: 'We obtain a temporary street-use permit from the Newark Department of Engineering for dumpster placement, typically positioning the container directly in front of the building. Conveyor systems direct debris from the roof into the dumpster to minimize ground-level mess. Magnetic nail sweepers run continuously along the sidewalk and street perimeter. On streets too narrow for roll-off containers, we use smaller debris bins shuttled by truck to a transfer point. Dumpster exchanges are scheduled during off-peak hours to reduce traffic impact, and no-parking signs go up 48 hours before the project per city requirements.'
    },
    {
      question: 'What happens if the tear-off reveals structural problems with my roof deck?',
      answer: 'Structural discoveries are common on Newark buildings, especially those built before 1950. When we find rotted sheathing, we replace it with code-compliant plywood or OSB before proceeding. If we discover rafter damage, sagging, or inadequate framing, we document the condition, photograph it, and discuss repair options with you before continuing. Our estimates include a contingency allowance for typical deck repair based on the building\'s age and visible condition. Significant structural work beyond the contingency is quoted separately and requires your approval before we proceed.'
    },
    {
      question: 'How long does a full tear-off and replacement take on a Newark building?',
      answer: 'A standard single-family home in Newark takes three to four working days: one day for tear-off and deck assessment, one to two days for installation, and a final day for flashing details, cleanup, and inspection. Three-family buildings typically require five to seven days. Weather delays can extend the timeline, but we never leave an open deck unprotected overnight -- temporary weatherproofing is applied to any exposed sections at the end of each work day. We provide a project timeline specific to your building during the estimate phase.'
    },
    {
