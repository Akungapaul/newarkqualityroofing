...
export const newarkHistoricRoofRestoration: ComboContent = {
  ...
  faqs: [
    {
      question: 'Is my Newark home eligible for historic preservation tax credits for roof restoration?',
      answer: 'Properties individually listed on the National Register of Historic Places or contributing structures within a National Register historic district may qualify for the federal twenty-percent historic preservation tax credit on eligible rehabilitation expenses. New Jersey offers an additional state tax credit for qualified historic properties. The roof restoration must follow the Secretary of the Interior\'s Standards for Rehabilitation. We assist with the tax credit application process and ensure restoration work meets certification requirements.',
    },
    {
      question: 'Can a historic slate roof be repaired rather than fully replaced?',
      answer: 'In many cases, yes. A well-installed slate roof can last 75 to 150 years depending on the slate variety. If the majority of slates remain sound and the underlayment and flashing are serviceable, targeted repairs -- replacing cracked or missing individual slates, re-securing slipped slates, and reflashing worn valleys and penetrations -- can extend the roof\'s service life by decades at a fraction of full replacement cost. Our assessment identifies whether repair or replacement is the more cost-effective long-term approach.',
    },
    {
      question: 'What if the original slate color is no longer available from any quarry?',
      answer: 'We pursue multiple sourcing strategies. First, we search salvage networks for reclaimed slate from demolished buildings of the same era. Second, we evaluate current quarry production for the closest color and texture match. Third, for situations where slate matching is truly impossible, we consider high-quality synthetic slate products that can be manufactured to replicate specific historic profiles. The chosen approach depends on preservation commission requirements and the owner\'s budget and priorities.',
    },
    {
      question: 'How long does a typical historic roof restoration take in Newark?',
      answer: 'Timeline varies significantly with project scope. A targeted slate repair on a single-family Victorian home may take one to two weeks of field work. A full restoration of a large historic building with custom copper fabrication, preservation commission review, and tax credit documentation can span four to eight months from assessment to completion. Material procurement and regulatory approvals typically account for more elapsed time than the physical restoration work.',
    },
    {
