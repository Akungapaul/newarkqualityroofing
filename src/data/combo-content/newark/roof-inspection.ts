...
export const newarkRoofInspection: ComboContent = {
  ...
  faqs: [
    {
      question: 'What does a pre-purchase roof inspection cost for a Newark brownstone?',
      answer: 'A comprehensive pre-purchase roof inspection for a typical Newark brownstone runs between $350 and $550 depending on building size, roof complexity, and access requirements. This includes physical inspection of all roof surfaces, attic space evaluation, party-wall flashing assessment, and a detailed written report with photos and recommendations. The cost is separate from a general home inspection and provides significantly more depth on the roof system than a generalist inspector can offer. For multi-family brownstones with more than three units, pricing increases to reflect the additional interior access points and inspection scope required.'
    },
    {
      question: 'How often should commercial buildings in Newark have their roofs inspected?',
      answer: 'Commercial flat-roof systems in Newark should be professionally inspected twice per year -- once in spring after freeze-thaw season and once in late fall before winter weather begins. Additionally, inspections should occur after any significant storm event and whenever interior leaks are reported. Most commercial roof warranties, including those on TPO and EPDM systems common on Ironbound and Broad Street buildings, require documented annual inspections to maintain coverage. We offer commercial maintenance contracts that bundle these inspections with minor repair services at a reduced annual rate.'
    },
    {
      question: 'Can you inspect a Newark roof without going on it?',
      answer: 'We use drone-assisted photography for initial exterior assessment and for documenting conditions on roof sections that are unsafe for foot traffic. However, a thorough inspection requires physical access to the roof surface for moisture probing, membrane adhesion testing, and flashing detail examination. Drone imagery alone cannot detect soft spots in the deck, measure the depth of ponding water, or assess the condition of concealed flashing behind parapets. We use drones as a supplement to physical inspection, not a replacement -- and our pricing reflects the full-access inspection standard that Newark\'s complex building stock demands.'
    },
    {
