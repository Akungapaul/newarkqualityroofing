...
export const fairfieldEmergencyRoofRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'How quickly can you respond to a roof emergency in Fairfield?',
      answer: 'We typically arrive within two to four hours for active emergencies in Fairfield during standard hours. After-hours emergencies are triaged by severity -- active water entry affecting occupied spaces receives immediate dispatch, while damage without active leaking is scheduled for first-light response. Route 46 commercial properties with standing emergency authorization receive the fastest response because access delays are eliminated.'
    },
    {
      question: 'A tree branch went through my Fairfield roof. What should I do first?',
      answer: 'Do not attempt to remove the branch yourself -- it may be providing temporary weather protection. Move belongings away from the damage area, place containers to catch dripping water, and call us immediately. Our crew will assess whether the branch has caused structural damage to rafters or trusses, stabilize the opening with temporary weatherproofing, and arrange for the branch removal in coordination with the structural repair plan.'
    },
    {
      question: 'Will my insurance cover emergency roof repair in Fairfield?',
      answer: 'Most homeowner policies cover sudden storm damage, tree impacts, and wind damage. They generally do not cover damage resulting from deferred maintenance or gradual deterioration. We provide insurance-ready documentation for every emergency repair including timestamped photographs, damage cause assessment, and material specifications. Many Fairfield homeowners find that our documentation significantly speeds the claims process compared to filing without professional support.'
    },
    {
