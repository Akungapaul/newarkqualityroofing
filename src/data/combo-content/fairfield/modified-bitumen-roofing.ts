...
export const fairfieldModifiedBitumenRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'Is modified bitumen a good choice for Fairfield restaurant and food-service buildings?',
      answer: 'Modified bitumen is an excellent choice for Fairfield restaurant properties. The multi-layer membrane resists the grease, heat, and chemical exposure that food-service exhaust deposits on roof surfaces. Its puncture resistance handles the heavy foot traffic from HVAC and kitchen equipment maintenance. And the reinforced membrane withstands the thermal stress from commercial kitchen exhaust that can soften thinner single-ply membranes. Several Route 46 restaurant properties rely on modified bitumen specifically for these performance characteristics.'
    },
    {
      question: 'Should I choose SBS or APP modified bitumen for my Fairfield commercial roof?',
      answer: 'SBS-modified bitumen contains rubber polymers that provide superior flexibility and cold-weather performance, making it our standard recommendation for Fairfield\'s freeze-thaw climate. APP-modified bitumen uses plastic polymers that offer better heat resistance and UV stability. For most Fairfield commercial applications, SBS is the better choice because the flexibility it provides during winter temperature swings prevents the cracking that rigid membranes develop. We use APP selectively on buildings with unusually high heat exposure from mechanical equipment or industrial processes.'
    },
    {
      question: 'Can modified bitumen be installed over my existing Fairfield commercial roof?',
      answer: 'If the existing roof assembly is dry and structurally sound, a modified bitumen recover can be installed over the existing surface. This approach saves tear-off cost and shortens project duration. We verify existing conditions through core sampling at multiple locations across the roof. Fairfield building code limits total roof layers, so buildings approaching the maximum may require partial or full tear-off before recovering. Our assessment identifies the most cost-effective approach for each property.'
    },
    {
