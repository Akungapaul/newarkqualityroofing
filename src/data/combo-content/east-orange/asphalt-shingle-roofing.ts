...
export const eastOrangeAsphaltShingleRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'What is the best asphalt shingle choice for an East Orange rental property renovation?',
      answer: 'For most East Orange rental properties, a mid-range architectural shingle with a 30-year warranty delivers the optimal balance of installed cost, visual appeal, and durability. Avoid three-tab shingles on rental properties -- the cost savings is minimal, but three-tab products age visibly faster, reducing curb appeal and potentially affecting tenant quality. If the property is in a rehabilitation zone, documenting the shingle specification supports your application for improvement credits. We provide material cost comparisons with per-year lifecycle analysis so investors can make data-driven decisions.'
    },
    {
      question: 'How many layers of shingles can my East Orange building support?',
      answer: 'New Jersey building code permits a maximum of two layers of asphalt shingles. However, many East Orange properties already have two or three layers from previous installations done without permits. We check existing layer count during our inspection. If two or more layers are present, full tear-off to bare deck is required before new shingle installation. There is no safe or code-compliant shortcut around this requirement, and any contractor who proposes installing over three existing layers is creating a structural risk and code violation.'
    },
    {
      question: 'My East Orange Victorian has poor attic ventilation. Will this void my shingle warranty?',
      answer: 'Most manufacturer warranties require adequate attic ventilation as a condition of coverage. We assess ventilation during every East Orange installation and add ridge vents, soffit vents, or gable vents where physically possible within the building geometry. When the Victorian roof form prevents achieving the manufacturer\'s ideal ventilation ratio, we document the installed ventilation level and select shingle products with SBS-modified formulations designed to tolerate higher attic temperatures. This approach provides the best achievable protection within the constraints of the building\'s historic architecture.'
    },
    {
