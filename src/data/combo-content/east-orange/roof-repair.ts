...
export const eastOrangeRoofRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'How do you handle roof repairs on East Orange multi-family buildings with occupied units below?',
      answer: 'We coordinate with property managers on tenant notification and access scheduling. New Jersey law requires 24-hour notice for non-emergency unit access. For emergency leaks with active water entry, we document the emergency condition and begin exterior repairs immediately while the property manager arranges interior access for damage assessment. Our crews minimize interior disruption by performing all possible work from the roof side, entering units only when interior moisture mapping or ceiling access is necessary to confirm the repair scope.'
    },
    {
      question: 'My East Orange apartment building has been patched multiple times and still leaks. What is the next step?',
      answer: 'Repeated patch failures on East Orange apartment buildings usually indicate either a systemic membrane failure that exceeds what spot repairs can address, or moisture trapped between roof layers that migrates to new locations after each patch. We perform an infrared moisture survey to map the full extent of wetted insulation beneath the membrane. If more than 25 percent of the roof area shows trapped moisture, targeted repair is no longer cost-effective and a phased re-roofing plan is the better investment. We can phase the work across budget cycles to manage cash flow for property owners.'
    },
    {
      question: 'Does East Orange require permits for roof repairs on multi-family properties?',
      answer: 'Minor repairs such as patching, re-sealing flashings, and replacing individual shingles generally do not require permits. However, East Orange code enforcement actively monitors multi-family properties, and repairs involving more than 25 percent of the roof surface, structural modifications, or changes to drainage patterns require a building permit from the East Orange Building Department. Properties in the rehabilitation zone may have additional requirements. We handle all permit applications and ensure work meets current code standards.'
    },
    {
