...
export const essexFellsRoofVentInstallationRepair: ComboContent = {
  ...
  conversionHooks: {
    midPageCta: 'Get your free roof vent installation repair estimate in Essex Fells — call now or fill out our form.',
