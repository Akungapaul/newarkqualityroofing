...
export const nutleyCedarShakeRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'How long does a cedar shake roof last on a Nutley home?',
      answer: 'A properly installed and maintained cedar shake roof in Nutley lasts 30 to 40 years. The primary variable is maintenance consistency. Homes near The Oval with good sun exposure and diligent biannual treatment reach the upper end. Properties in heavily shaded sections like Yantacaw or Kingsland that go more than three years without treatment may see only 20 to 25 years before replacement becomes necessary. Our maintenance program includes biannual cleaning, preservative application, and replacement of any individual shakes showing early deterioration.'
    },
    {
      question: 'Is cedar shake roofing allowed under Nutley fire codes?',
      answer: 'Yes, with fire-retardant treatment. Untreated cedar does not meet New Jersey residential fire code requirements. We exclusively install pressure-treated cedar shakes with fire-retardant impregnation achieving Class B or Class A fire resistance ratings. The treatment is warranted for 20 years and does not alter the visual appearance of the cedar. We also install fire-resistant underlayment as standard practice on all Nutley cedar installations for additional safety.'
    },
    {
      question: 'What does cedar shake roofing cost compared to premium asphalt shingles in Nutley?',
      answer: 'Cedar shake roofing in Nutley typically costs 2.5 to 3.5 times more than premium architectural shingles at installation. A Tudor home that might cost 25,000 to 35,000 dollars for GAF Grand Canyon shingles could run 65,000 to 100,000 dollars for hand-split cedar shakes, depending on roof size and complexity. The lifecycle comparison narrows this gap because cedar lasts 30 to 40 years versus 25 to 30 for premium shingles, but cedar requires ongoing biannual treatment that adds roughly 800 to 1,200 dollars every two years.'
    },
    {
      question: 'How do you prevent moss growth on cedar roofs under Nutley shade trees?',
      answer: 'Preventing moss on shaded cedar roofs requires a three-part approach. First, annual debris clearing to remove the leaf litter and organic matter that moss colonizes. Second, biannual application of penetrating wood preservative with integrated mildewcide that inhibits spore germination on the cedar surface. Third, selective canopy management to improve air circulation and light penetration where possible without conflicting with Nutley shade tree commission guidelines. Properties with heavy canopy coverage may also benefit from zinc or copper ridge strips that release trace amounts of algicide during rain events.'
    },
    {
