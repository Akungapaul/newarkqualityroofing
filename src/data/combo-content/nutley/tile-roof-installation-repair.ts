...
export const nutleyTileRoofInstallationRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'Can my 1930s Nutley Colonial support a tile roof without major structural work?',
      answer: 'Many 1930s Colonials in Nutley were built with 2x8 or 2x10 rafters on 16-inch centers with dimensional lumber that exceeds what modern framing provides. These homes often can support concrete tile with minimal or no reinforcement. Clay tile, being slightly lighter than concrete tile, is even more likely to work within existing framing capacity. However, every home is different, and we require a structural engineer evaluation before committing to tile. Approximately two-thirds of pre-war Nutley homes pass structural review for tile installation without modification.'
    },
    {
      question: 'How does tile roofing perform during Nutley winter storms?',
      answer: 'Tile roofing performs exceptionally well in winter weather. The thermal mass moderates temperature fluctuations that cause ice dam formation, the batten system provides an air gap that reduces heat transfer from the attic, and the rigid surface sheds snow loads effectively on Nutley\'s steeper pitches. Ice-and-water shield membrane installed beneath the tile at eaves and valleys provides the same backup protection used on shingle roofs. The main winter concern is impact damage from falling tree limbs, which can crack individual tiles -- but cracked tiles are individually replaceable without disturbing the surrounding field.'
    },
    {
      question: 'What does a tile roof installation cost compared to premium shingles in Nutley?',
      answer: 'Tile roof installation in Nutley typically costs two to three times more than premium architectural shingles when comparing installed price per square foot. A home that might cost 22,000 to 28,000 dollars for a GAF Grand Canyon shingle installation could run 50,000 to 75,000 dollars for concrete tile and 65,000 to 95,000 dollars for natural clay tile. The lifecycle cost comparison favors tile: a 75-year tile roof eliminates two or three shingle replacement cycles that would occur over the same period. Many Nutley homeowners view tile as a permanent investment rather than a recurring expense.'
    },
    {
