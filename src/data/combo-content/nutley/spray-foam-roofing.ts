...
export const nutleySprayFoamRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'How long does a spray foam roof last on a Nutley commercial building?',
      answer: 'The SPF substrate lasts 30 years or longer when protected by properly maintained elastomeric coating. The coating itself requires renewal every 10 to 15 years for silicone systems or 7 to 10 years for acrylic systems. This re-coating maintenance is the essential obligation of spray foam ownership. Building owners who maintain the coating cycle can extend total system life to 40 or even 50 years, making spray foam one of the longest-lasting commercial roofing options available for Nutley properties.'
    },
    {
      question: 'Can spray foam be applied over my existing Nutley commercial roof?',
      answer: 'In most cases, yes. Spray foam adheres to virtually any clean, dry, structurally sound substrate including EPDM, TPO, PVC, modified bitumen, built-up roofing, and metal panels. The existing roof must be dry -- moisture trapped beneath the foam will cause adhesion failure and blistering. We moisture-test the existing assembly before application and address any wet sections through localized removal before foam application begins. The ability to coat over existing roofing eliminates tear-off cost and landfill waste on conversion projects.'
    },
    {
      question: 'What R-value does spray foam roofing provide on Nutley buildings?',
      answer: 'Closed-cell spray polyurethane foam provides approximately R-6.5 per inch of thickness. A typical two-inch application delivers R-13, and three inches provides R-19.5. We can build to any thickness needed to meet current energy code requirements or the building owner\'s desired thermal performance. The seamless application eliminates thermal bridging at fastener points and insulation joints, delivering actual thermal performance that closely matches the calculated R-value -- unlike mechanically attached insulation systems where thermal bridging can reduce effective R-value by 15 to 25 percent.'
    },
    {
