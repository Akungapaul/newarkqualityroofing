...
export const veronaInfraredRoofLeakDetection: ComboContent = {
  ...
  faqs: [
    {
      ...
      answer: 'The technology is the same -- both use infrared cameras to detect temperature differentials on the roof surface. The difference is in application focus. Thermal imaging inspection is a general assessment of roof condition, evaluating moisture, insulation performance, and energy loss across the entire roof. Infrared leak detection is specifically targeted at finding the source of an active or chronic leak, with the analysis focused on correlating moisture locations with the building\'s leak symptoms.'
    },
    {
      question: 'Can infrared detection find leaks on my Verona building during winter?',
      answer: 'Winter scanning is less reliable than warm-season scanning because the reduced solar heating during short winter days produces weaker thermal differentials. However, winter scans can still be productive on dark-surfaced roofs that absorb available solar radiation and on buildings where interior heating creates a strong temperature gradient through the roof assembly. For urgent leak situations during winter, we perform scans with adjusted interpretation parameters and supplement with other diagnostic methods.'
    },
    {
      question: 'How much area of my Verona roof needs replacement based on infrared results?',
      answer: 'The infrared scan quantifies the wet insulation area, which determines the replacement scope. On many Verona commercial buildings, the wet area represents 10 to 20 percent of the total roof surface, allowing targeted repair of the damaged zones rather than full replacement. When wet areas exceed 25 to 30 percent of the roof surface, full replacement becomes more cost-effective than patching multiple sections. The infrared data provides the measurement needed to make this decision objectively.'
    },
    {
