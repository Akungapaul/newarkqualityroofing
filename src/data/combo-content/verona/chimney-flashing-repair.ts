...
export const veronaChimneyFlashingRepair: ComboContent = {
  ...
  faqs: [
    ...
    {
      question: 'Does my Verona chimney need a cricket?',
      answer: 'Building codes require a cricket on the upslope side of any chimney wider than 30 inches measured perpendicular to the slope. Most Verona masonry chimneys exceed this width. If your chimney has no cricket and you notice water staining on the interior wall behind the chimney, the absence of a diverter is likely contributing to water pooling against the chimney back wall. We evaluate the need during our assessment and include cricket construction in the repair scope when warranted.'
    },
    {
