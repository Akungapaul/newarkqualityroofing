...
export const veronaHistoricRoofRestoration: ComboContent = {
  ...
  faqs: [
    {
      question: 'Does Verona have historic preservation requirements for roof restoration?',
      answer: 'Verona does not have a formal historic preservation commission or mandatory design review for residential properties. However, homeowners of pre-war homes often choose period-appropriate restoration voluntarily to maintain their home\'s architectural integrity and property value. If your home is individually listed on the National Register of Historic Places, certain restoration standards apply for tax credit eligibility. We advise homeowners on the distinction between voluntary preservation and any applicable regulatory requirements for their specific property.'
    },
    {
      question: 'Can I replace my historic Verona slate roof with modern shingles?',
      answer: 'You legally can in most cases, but we strongly advise against it for both aesthetic and financial reasons. Original slate adds significant value to Verona pre-war homes, and replacing it with shingles diminishes the home\'s architectural character and resale appeal. Slate restoration -- even with selective replacement of damaged pieces -- is often more cost-effective than full slate removal and shingle installation when you factor in the property value impact. We present both options with full cost and value analysis so you can make an informed decision.'
    },
    {
      question: 'How long does a historic roof restoration take in Verona?',
      answer: 'Timeline depends heavily on material sourcing. Once materials are in hand, the restoration work typically takes two to four weeks for a full-house slate or tile restoration. The material sourcing phase can add one to six months depending on the rarity of the required materials. We begin sourcing well in advance of the planned installation date, and we can perform emergency stabilization repairs to prevent water damage while sourcing proceeds for the full restoration.'
    },
    {
