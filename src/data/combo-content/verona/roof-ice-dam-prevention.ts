...
export const veronaRoofIceDamPrevention: ComboContent = {
  ...
  conversionHooks: {
    midPageCta: 'Get your free roof ice dam prevention estimate in Verona — call now or fill out our form.',
