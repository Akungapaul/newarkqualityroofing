...
export const montclairGutterInstallationRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'What type of gutters should I install on my Montclair Victorian home?',
      answer: 'Half-round copper gutters are the architecturally appropriate choice for Montclair Victorians and will satisfy the Historic Preservation Commission if your property is designated. Copper develops a natural patina that complements the building\'s aged character, requires no painting, and outlasts all other gutter materials with an expected lifespan of 60 to 80 years. For non-designated Victorians where budget is a factor, heavy-gauge seamless aluminum in a dark bronze or custom-matched color provides period-sympathetic appearance at roughly one-third the copper installation cost.'
    },
    {
      question: 'Do gutter guards actually work under Montclair\'s heavy tree canopy?',
      answer: 'Some do; most do not. We have tested and rejected the majority of gutter guard products for Montclair conditions. Screen-type guards clog with oak catkins and maple seeds. Foam inserts compress under debris weight and hold moisture. The products we do recommend are solid-cover surface-tension designs engineered for steep-pitch installations, which shed large leaves and let water sheet into the gutter channel. Even with the best guards, annual professional inspection is necessary in Montclair to clear accumulated fine debris from the guard surface and ensure water entry remains unobstructed.'
    },
    {
      question: 'How often should gutters be cleaned in Montclair?',
      answer: 'Under Montclair\'s heavy tree canopy, gutters without guards need three to four cleanings per year: once after spring seed drop, once during peak leaf fall in October or November, once after the late leaf drop in December, and a check after winter to clear any ice-dam debris. Properties with effective gutter guard systems can reduce this to one or two annual professional inspections. The exact schedule depends on the tree species surrounding your property -- we provide a customized maintenance calendar based on the specific canopy composition at your home.'
    },
    {
      question: 'Can you match new copper gutters to the patina on my existing system?',
      answer: 'New copper arrives bright and will develop its own green-brown patina over two to five years depending on exposure. For repairs where a single new section would contrast sharply with weathered existing gutters, we apply accelerated patination solutions that age the surface to blend with the surrounding material. For full replacements, the entire system weathers uniformly over time. We also source pre-patinated copper when available, though supply is limited and lead times are longer than bright copper.'
    },
    {
