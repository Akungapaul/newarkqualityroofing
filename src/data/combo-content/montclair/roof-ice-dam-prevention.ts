...
export const montclairRoofIceDamPrevention: ComboContent = {
  ...
  faqs: [
    {
      question: 'Why does my Montclair home get ice dams every winter?',
      answer: 'Ice dams form when heat escaping from your living space warms the attic, melting snow on the roof surface above. The meltwater flows down to the eave where the roof extends beyond the heated space and refreezes. Montclair homes are particularly susceptible because of older construction with minimal insulation, multiple ceiling penetrations that leak warm air, complex roof geometries that create poorly ventilated attic compartments, and the township\'s colder ridge-elevation temperatures. The root cause is almost always insufficient insulation and air sealing rather than a roofing material problem.'
    },
    {
      question: 'Do heat cables prevent ice dams on Montclair homes?',
      answer: 'Heat cables manage ice dams by melting channels through the ice that allow trapped water to drain rather than backing up under shingles. They are a symptom management tool, not a prevention solution. The heat loss that causes ice dams continues, and the cables consume electricity throughout the winter. We recommend heat cables only as a supplemental measure on Montclair homes where complete attic thermal improvement is impractical due to access limitations or cathedral ceiling construction. The primary investment should address insulation and air sealing to reduce the heat loss driving ice formation.'
    },
    {
      question: 'How much does ice dam prevention cost for a Montclair home?',
      answer: 'Comprehensive ice dam prevention through air sealing, insulation upgrade, and ventilation improvement typically costs three thousand to eight thousand dollars for a Montclair home, depending on attic accessibility, existing insulation condition, and the number of compartments requiring individual treatment. This investment eliminates or dramatically reduces the annual interior water damage, emergency ice removal costs, and ongoing repair expenses that chronic ice dams produce. Most Montclair homeowners with serious ice dam histories recoup the prevention investment within two to four winters through avoided damage and repair costs.'
    },
    {
