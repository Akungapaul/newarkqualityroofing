...
export const montclairRoofInspection: ComboContent = {
  ...
  faqs: [
    {
      question: 'How is a professional roof inspection different from what my home inspector checks?',
      answer: 'A general home inspector typically spends fifteen to thirty minutes on the roof, checks visible surface condition from a walkable vantage point, and reports general observations. Our roof-specific inspections last two to four hours on Montclair homes, include harness-equipped access to every roof plane regardless of pitch, clear organic growth for material assessment beneath, inspect every flashing detail and penetration at close range, and include attic-side evaluation. The resulting report provides material-specific remaining life estimates and itemized repair costs rather than general condition ratings.'
    },
    {
      question: 'How often should I have my Montclair roof inspected?',
      answer: 'We recommend biennial inspections for most Montclair homes, with annual inspections for properties with original slate roofs over fifty years old, heavy tree canopy exposure, or known ventilation deficiencies. Post-storm inspections are recommended after any event with sustained winds exceeding fifty miles per hour or confirmed hail. Properties on the Watchung Ridge that experience higher wind exposure benefit from annual inspection to catch wind-related fastener and flashing loosening before it produces leaks.'
    },
    {
      question: 'What does a Montclair roof inspection cost?',
      answer: 'Inspection fees for Montclair homes range from four hundred to eight hundred dollars depending on roof size, complexity, and accessibility. Victorian homes with steep pitches, multiple dormers, and complex geometry fall at the higher end due to the extended time and safety equipment required. The investment typically pays for itself many times over in pre-purchase negotiations where identified deficiencies support price adjustments, or in maintenance contexts where early detection prevents expensive emergency repairs.'
    },
    {
