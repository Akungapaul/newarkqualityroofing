...
export const montclairRoofMaintenancePrograms: ComboContent = {
  ...
  faqs: [
    {
      question: 'How much does an annual roof maintenance program cost for a Montclair home?',
      answer: 'Program costs for Montclair homes range from nine hundred to two thousand dollars annually, depending on roof size, material type, pitch steepness, and tree canopy density. Victorian homes with steep slate roofs and heavy canopy exposure fall at the higher end due to specialized material handling and safety equipment requirements. The annual program cost is typically five to ten percent of what a single emergency repair costs, making it among the highest-return investments a Montclair homeowner can make in property preservation.'
    },
    {
      question: 'What is included in each maintenance visit?',
      answer: 'Each visit includes full debris clearing from all roof surfaces and valleys, gutter and downspout flushing with flow verification, inspection of all flashing and sealant joints, moss and lichen treatment, ventilation component check, and an attic-side moisture scan where accessible. Minor repairs -- replacing a cracked slate, re-sealing a loose flashing joint, re-securing a lifted shingle tab -- are performed during the visit at no additional charge when they fall within the program scope. Larger repairs discovered during maintenance are documented and quoted separately.'
    },
    {
      question: 'Can you maintain a copper gutter system as part of the roof maintenance program?',
      answer: 'Yes. Copper gutter maintenance -- including interior flush, joint inspection, solder integrity check, and outlet flow verification -- is included in our comprehensive programs. For Montclair Victorians with half-round copper gutters, this maintenance is particularly valuable because copper joint repair requires soldering skills that gutter cleaning services do not offer. Identifying a fatigued solder joint during routine maintenance and repairing it in place costs a fraction of the emergency repair after the joint fails and water damages the fascia and foundation below.'
    },
    {
