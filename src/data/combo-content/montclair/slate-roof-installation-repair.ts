...
export const montclairSlateRoofInstallationRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'How long does a slate roof last in Montclair?',
      answer: 'Service life depends on the quarry source. Vermont unfading slate is rated for 150 to 200 years. Pennsylvania soft-vein slate lasts 50 to 75 years. Pennsylvania hard-vein and Virginia Buckingham slate fall between 75 and 125 years. Most surviving original slate in Montclair is from hard-vein sources and has another 25 to 50 years of service remaining when properly maintained. New installations using premium Vermont or Buckingham slate will outlast the current homeowner and several subsequent owners.'
    },
    {
      question: 'What does a new slate roof cost on a Montclair Victorian?',
      answer: 'Installed cost for a new slate roof on a typical Montclair Victorian ranges from thirty-five thousand to sixty-five thousand dollars depending on the quarry source, roof complexity, and pitch steepness. The per-square-foot cost is roughly four to six times that of premium architectural shingles. However, the cost per year of service -- calculated over the slate\'s century-plus lifespan -- is lower than any other roofing material. The investment also preserves the home\'s architectural integrity and supports its market value in Montclair\'s premium real estate environment.'
    },
    {
      question: 'Can damaged slates be replaced individually without disturbing the surrounding roof?',
      answer: 'Yes. Individual slate replacement is the standard repair technique and is how well-maintained slate roofs achieve their multi-century lifespans. The damaged slate is extracted using a slate ripper -- a specialized tool that cuts the hidden nails without disturbing adjacent courses. The replacement slate is installed using a copper bib-and-hook method that secures the new piece in the existing coursework. When the replacement slate is properly color-matched, the repair is virtually invisible within the surrounding field.'
    },
    {
