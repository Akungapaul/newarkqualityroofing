...
export const montclairRubberRoofingEpdm: ComboContent = {
  ...
  faqs: [
    {
      question: 'How long does EPDM rubber roofing last on Montclair flat roofs?',
      answer: 'Quality EPDM installations with proper insulation and drainage deliver twenty-five to thirty-five years of service in Montclair. Sixty-mil membrane outlasts forty-five-mil by approximately five to eight years. The membrane itself typically remains flexible and functional beyond the point where seam adhesive and flashing connections begin to fail, so the practical lifespan is often determined by the assembly details rather than the membrane material. Targeted seam and flashing repair at the twenty-year mark can extend total system life toward the upper range.'
    },
    {
      question: 'Is EPDM or TPO better for my Montclair flat roof?',
      answer: 'EPDM is typically the better choice when the flat section is concealed from view and budget efficiency is the priority. TPO is preferred when the roof surface is visible, when the reflective white surface provides meaningful energy savings for the conditioned space below, or when the roof will eventually support solar panels that benefit from a reflective surrounding surface. For Montclair porch roofs and concealed flat sections, EPDM provides equivalent waterproofing performance at lower installed cost.'
    },
    {
      question: 'Can an aging EPDM roof be repaired without full replacement?',
      answer: 'Yes. When the membrane itself remains flexible and the deck beneath is sound, failing seams and flashings can be repaired individually with compatible tape, adhesive, and uncured EPDM patch material. A systematic repair of all seams and flashings on a twenty-year-old EPDM roof typically costs thirty to forty percent of full replacement and extends service life by ten to fifteen years. We assess each aging installation to determine whether repair or replacement is the more cost-effective path based on the overall membrane condition and the extent of assembly deterioration.'
    },
    {
