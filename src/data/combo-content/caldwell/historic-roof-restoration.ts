...
export const caldwellHistoricRoofRestoration: ComboContent = {
  ...
  faqs: [
    {
      question: 'Does Caldwell require historic preservation permits for roof restoration?',
      answer: 'Caldwell does not have a formal historic preservation commission or overlay zone that requires preservation review for roof work. Standard building permits apply. However, properties listed on or eligible for the National Register of Historic Places may need to follow Secretary of the Interior Standards for restoration work if federal tax credits or grant funding is involved. We advise Caldwell property owners on any applicable requirements based on their property\'s specific historic designation status.'
    },
    {
      question: 'How much more does historic roof restoration cost compared to standard replacement?',
      answer: 'Historic restoration typically costs two to four times more than standard replacement, depending on the original materials being replicated and the complexity of the restoration details. Slate restoration is the most significant cost premium due to material procurement and specialized installation labor. The investment is justified when the property\'s architectural character, historical significance, or owner\'s preservation commitment makes authentic restoration the appropriate choice. We provide detailed cost comparison between restoration and standard replacement so the decision is made with full financial information.'
    },
    {
      question: 'Can you restore a slate roof on my older Caldwell home?',
      answer: 'Yes. Slate restoration involves evaluating each existing slate for soundness, replacing broken or deteriorated slates with matching material, renewing flashing and underlayment, and repairing any substrate damage. If the slate field is largely intact with isolated failures, selective replacement preserves the existing installation at significantly lower cost than full replacement. If the slate is widely deteriorated, full replacement with new or salvage slate matching the original profile and color restores the roof to its original condition.'
    },
    {
