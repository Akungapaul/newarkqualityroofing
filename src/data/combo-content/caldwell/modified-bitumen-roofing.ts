...
export const caldwellModifiedBitumenRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'What is the advantage of modified bitumen over single-ply roofing for Caldwell buildings?',
      answer: 'Modified bitumen\'s primary advantage is multi-layer redundancy. A puncture that would leak immediately on a single-ply membrane encounters a second waterproof layer beneath the cap sheet on a modified bitumen system. For Caldwell buildings beneath tree canopy where falling debris creates puncture risk, this redundancy provides meaningful protection against the most common cause of flat roof leaks in this borough. Modified bitumen also self-heals minor punctures as the polymer-modified asphalt flows back together under solar warming.'
    },
    {
      question: 'How long does modified bitumen roofing last on Caldwell commercial buildings?',
      answer: 'Properly installed modified bitumen systems in Caldwell deliver twenty to thirty years of service. The multi-layer construction means the system degrades gradually rather than catastrophically -- cap sheet granule loss exposes the membrane to UV, which eventually cracks the surface layer, but the base sheet continues providing waterproofing beneath. This progressive degradation gives building owners time to plan replacement rather than responding to sudden failure, and periodic coating maintenance can extend cap sheet life significantly.'
    },
    {
      question: 'Is torch-applied or cold-applied modified bitumen better for my Caldwell building?',
      answer: 'Torch application produces stronger seam bonds and is our preference when building conditions permit safe torch work. Cold-applied adhesive is the appropriate choice when combustible parapet construction, adjacent buildings, or other fire risk factors make open flame inadvisable. Both methods produce reliable waterproofing when properly executed. We assess your specific Caldwell building and recommend the application method that delivers the best performance within safe working parameters.'
    },
    {
