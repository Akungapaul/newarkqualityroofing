...
export const northCaldwellChimneyFlashingRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'Why do chimney flashings fail more often than other roof flashings?',
      answer: 'Chimneys endure more stress than other roof penetrations. The masonry mass absorbs heat differently than the surrounding roof, creating thermal movement at the junction. Chimneys project above the roofline where wind-driven rain concentrates at the intersection. The mortar joints that anchor counterflashing deteriorate from weather exposure on all four sides simultaneously. These combined stresses make chimney flashings the most failure-prone detail on any roof system.'
    },
    {
      question: 'Should chimney flashing repair include mortar repointing on my North Caldwell estate?',
      answer: 'Yes, when the mortar joints at the roofline and above are deteriorated. Repointing the mortar in the counterflashing reglets and the surrounding courses ensures that the repaired flashing has a sound substrate to seat into. We focus repointing on the chimney sections at and above the roofline where weather exposure is greatest. Full chimney repointing below the roofline is masonry work that we can coordinate but typically falls outside the flashing repair scope.'
    },
    {
      question: 'How much does chimney flashing repair cost on a North Caldwell estate?',
      answer: 'Cost depends on chimney size, flashing material, and the extent of deterioration. A standard chimney reflashing with copper materials on a North Caldwell estate typically ranges higher than the same work on a standard suburban home due to the larger chimney dimensions, premium material specifications, and the multi-story access requirements typical of these properties. We provide detailed estimates that itemize materials, labor, and access costs for each chimney.'
    },
    {
