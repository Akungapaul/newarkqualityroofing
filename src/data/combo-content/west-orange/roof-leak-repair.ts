...
export const westOrangeRoofLeakRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'Why does my West Orange split-level always leak at the level-change transition?',
      answer: 'The level-change transition on split-level homes is the single most failure-prone point in their roof design. Water running down the upper roof plane hits the wall where the lower roof begins, creating hydraulic pressure against flashings that were often undersized or improperly installed in the original 1960s construction. Many previous repairs attempted to solve this with caulk -- a temporary fix that fails within one to three seasons. A permanent repair requires a properly sized cricket flashing that diverts water around the transition, continuous counter-flashing set into a reglet cut in the wall, and ice-and-water shield extending 3 feet above and below the intersection.'
    },
    {
      question: 'How do you find the source of a wind-driven roof leak on an Eagle Rock home?',
      answer: 'Wind-driven leaks on ridge-top properties only appear during storms with specific wind directions, making them invisible during calm-weather inspections. We use pressurized water testing to simulate storm conditions, systematically applying water to suspected penetration points while a second technician monitors the attic for moisture entry. Common wind-driven entry points include ridge vents, step flashings at dormers, and the micro-gaps in shingle lamination caused by wind fatigue. This diagnostic method identifies the exact penetration point without waiting for the next storm to reproduce the leak.'
    },
    {
      question: 'What is the typical cost to repair an ice dam leak in West Orange?',
      answer: 'Ice dam leak repair costs vary based on the extent of damage and the corrective measures needed. Simple shingle and underlayment repair from a single ice dam event typically runs $800 to $1,500. If damaged roof decking requires replacement, costs increase to $2,000 to $4,000. A comprehensive fix that includes ice-and-water shield retrofit and attic ventilation improvement to prevent future ice dams runs $3,000 to $6,000. We recommend the comprehensive approach for north-facing slopes above 300 feet elevation where ice dams are a recurring annual event rather than an occasional occurrence.'
    },
    {
