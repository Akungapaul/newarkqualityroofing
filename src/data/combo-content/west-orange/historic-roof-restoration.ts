...
export const westOrangeHistoricRoofRestoration: ComboContent = {
  ...
  faqs: [
    {
      question: 'How do you match slate for historic restoration on a Llewellyn Park estate?',
      answer: 'We maintain relationships with Pennsylvania and Vermont quarries that produce slate matching the original stone used on Llewellyn Park estates. For common profiles like Pennsylvania black or Vermont gray-green, quarry-matched new stone provides excellent visual continuity with existing weathered surfaces. For discontinued colors or unusual profiles, we access regional salvage networks and specialty importers. We source matching slate before restoration begins, bringing samples to the property for visual comparison in natural light alongside existing stone before committing to full procurement.'
    },
    {
      question: 'Can I get a tax credit for historic roof restoration in West Orange?',
      answer: 'Federal historic tax credits are available for income-producing properties listed on the National Register of Historic Places. New Jersey also offers historic preservation incentives through state programs. Residential properties in recognized historic districts may qualify for state-level credits depending on current program availability. We recommend consulting with a historic preservation tax specialist before beginning restoration work, as credit eligibility requires pre-approval and documentation procedures that must be followed from project initiation.'
    },
    {
      question: 'How long does a full slate roof restoration take in West Orange?',
      answer: 'Typical residential slate roof restoration takes 4 to 8 weeks of active work time, depending on roof size and complexity. Material sourcing adds 2 to 6 months of lead time before work begins. Complex estate projects with copper fabrication, decorative metalwork, and multiple roof sections can extend to 12 or more weeks of active work. We provide detailed project timelines during the proposal phase that account for both material sourcing and installation labor, setting realistic expectations for the full project duration.'
    },
    {
