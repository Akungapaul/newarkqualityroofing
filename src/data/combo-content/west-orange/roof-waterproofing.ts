...
export const westOrangeRoofWaterproofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'What is ice-and-water shield and do I need it on my West Orange home?',
      answer: 'Ice-and-water shield is a self-adhering rubberized membrane that seals around nail penetrations and prevents water entry even under the hydrostatic pressure that ice dams create. New Jersey building code requires it at eaves and valleys, but West Orange\'s elevation-driven ice dam risk often justifies coverage extending well beyond code minimums. We recommend 6 feet minimum from eaves on north-facing slopes above 300 feet elevation, compared to the 3-foot code minimum adequate for sheltered valley-floor installations.'
    },
    {
      question: 'Can waterproofing be added to my existing roof without replacement?',
      answer: 'Liquid-applied waterproofing can reinforce specific vulnerable details -- pipe boot connections, chimney base flashings, valley transitions -- without removing existing roofing materials. These targeted applications extend the waterproofing life of aging roofs by sealing the specific failure points where water entry occurs. However, the underlayment beneath existing shingles cannot be upgraded without roof removal. If the underlayment has deteriorated, full re-roofing with modern barrier materials is the only way to restore complete waterproofing protection.'
    },
    {
      question: 'Why does my West Orange home leak during heavy wind-driven rain but not during normal rain?',
      answer: 'Wind-driven rain creates horizontal water pressure that normal rainfall does not produce. Water driven at steep angles penetrates gaps behind step flashing, through ridge vent baffles, and around pipe boot collars -- gaps that gravity drainage would never reach. Ridge-top and windward-facing roof surfaces are most vulnerable. Waterproofing these pathways requires enhanced flashing coverage, wind-resistant ridge vent selection, and sealant application at lateral entry points that standard roofing installation does not address.'
    },
    {
