...
export const bloomfieldEpdmCommercialRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'How does EPDM compare to TPO for my Bloomfield commercial building?',
      answer: 'EPDM costs less to install and has a longer proven track record -- thirty-plus years of documented performance versus fifteen to twenty for TPO\'s current formulations. TPO\'s advantage is its reflective white surface, which reduces cooling costs on heavily air-conditioned buildings. For Bloomfield warehouses, workshops, and buildings with minimal cooling, EPDM\'s lower cost and proven longevity make it the practical choice. For Bloomfield Avenue offices and restaurants with substantial cooling loads, TPO may deliver enough energy savings to justify the cost premium.'
    },
    {
      question: 'What is the lifespan of an EPDM roof on a Bloomfield commercial property?',
      answer: 'A properly installed and maintained EPDM system delivers twenty-five to thirty years of service on Bloomfield commercial buildings. Many first-generation EPDM installations from the 1980s are still performing after forty years, though their seam systems have typically required re-treatment. Annual drain cleaning, periodic seam inspection, and prompt repair of any puncture or mechanical damage are the maintenance requirements that maximize EPDM service life.'
    },
    {
      question: 'Can EPDM be installed over my existing roof on Bloomfield Avenue?',
      answer: 'Recover installation over existing roofing is possible when the existing substrate is dry, structurally sound, and compatible with EPDM adhesive or mechanical attachment. We core-sample the existing roof to verify these conditions. If the existing insulation contains trapped moisture or if the building already carries two roof layers, tear-off to the structural deck is required. Recover saves the demolition cost when conditions permit, but honest assessment prevents installing new membrane over a compromised substrate that will cause premature failure.'
    },
    {
