...
export const bloomfieldRoofOverlayInstallation: ComboContent = {
  ...
  faqs: [
    {
      question: 'How much does a roof overlay save compared to tear-off in Bloomfield?',
      answer: 'Overlay saves approximately two to three dollars per square foot compared to tear-off -- roughly three thousand to five thousand dollars on a typical Bloomfield home. The savings come from eliminated demolition labor, dumpster rental, and disposal costs. The shingle material cost, underlayment, and installation labor are the same regardless of approach. The savings are meaningful but must be weighed against the inability to inspect and repair the deck.'
    },
    {
      question: 'Will my shingle warranty be affected by an overlay installation in Bloomfield?',
      answer: 'Most major shingle manufacturers provide full material warranty on overlay installations when performed per their specifications. Some manufacturers reduce the wind coverage or limit certain warranty provisions on overlay installations. We verify the specific warranty terms for the selected shingle product and disclose any overlay-related warranty limitations before proceeding so you can make an informed decision.'
    },
    {
      question: 'Can I overlay if my Bloomfield home already has two layers of shingles?',
      answer: 'No. New Jersey code limits asphalt shingle installations to two layers maximum. If your home already has two layers, full tear-off down to the deck is required before new shingles can be installed. We verify the layer count during our estimate visit by inspecting the exposed shingle edge at the eave or rake.'
    },
    {
