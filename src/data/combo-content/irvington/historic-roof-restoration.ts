...
export const irvingtonHistoricRoofRestoration: ComboContent = {
  ...
  faqs: [
    {
      question: 'Does my Irvington home qualify as historic for restoration purposes?',
      answer: 'Historic roof restoration does not require official landmark designation. Any Irvington home with original architectural roofing details worth preserving -- Tudor-era detailing, slate surfaces, decorative copper work, or craftsman-era design elements -- benefits from restoration-grade work that maintains these features rather than replacing them with generic modern materials.',
    },
    {
      question: 'How much more does historic restoration cost than standard re-roofing in Irvington?',
      answer: 'Historic restoration typically costs 40 to 100 percent more than standard re-roofing, depending on the materials involved and the extent of preservation work required. Slate restoration costs significantly more than shingle replacement. However, budget-sensitive options like synthetic slate and period-appropriate architectural shingles can reduce the premium while maintaining the building\'s historic appearance.',
    },
    {
      question: 'Can you restore the original slate roof on my Irvington home?',
      answer: 'If the original slate is natural stone and a sufficient percentage of tiles remain intact, selective restoration is often viable. We replace failed individual tiles with salvaged or new slate matching the original color, size, and thickness. When more than 40 to 50 percent of the slate surface has failed, full replacement with new natural slate or synthetic slate may be more cost-effective than selective restoration.',
    },
    {
