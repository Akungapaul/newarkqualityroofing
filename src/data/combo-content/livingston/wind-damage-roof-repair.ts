...
export const livingstonWindDamageRoofRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'How do I know if wind damaged my Livingston roof if shingles did not blow off?',
      answer: 'Wind damage often occurs without visible shingle loss. Look for lifted tab edges visible from ground level, exposed nail heads where shingles shifted, and debris accumulation from dislodged granules in gutters and at downspout discharge points. Creased shingle tabs indicate they lifted during wind loading and may or may not have re-sealed. A professional inspection determines whether the sealant bond is intact or the affected shingles need replacement.'
    },
    {
      question: 'Why does the same side of my Livingston roof always lose shingles during storms?',
      answer: 'Consistent wind damage on one elevation indicates that side faces the prevailing storm wind direction, typically the west or northwest in Livingston. The exposure to repeated wind loading progressively weakens sealant bonds and shingle adhesion on that face. Consider upgrading that elevation to high-wind-rated shingles with enhanced sealant strips during the next replacement cycle. Adding starter strip along the exposed rakes also significantly improves wind resistance on the vulnerable side.'
    },
    {
      question: 'Will my insurance cover wind damage to my Livingston roof?',
      answer: 'Homeowner insurance policies typically cover wind damage as a covered peril. We document damage with directional exposure analysis, impact photography, and repair specifications that align with insurance estimating standards. The key to claim approval is demonstrating that the damage pattern is consistent with the reported storm event rather than normal wear. Our documentation addresses this explicitly, correlating damage locations with wind direction data.'
    },
    {
