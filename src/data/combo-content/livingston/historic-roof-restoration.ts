...
export const livingstonHistoricRoofRestoration: ComboContent = {
  ...
  faqs: [
    {
      question: 'Is it worth restoring the slate roof on my historic Livingston home or should I replace it with asphalt?',
      answer: 'Restoring a slate roof costs more than asphalt replacement upfront but delivers superior long-term value. The restored slate will serve another 50 to 75 years, while asphalt requires replacement every 25 to 30 years. The restored slate also preserves your home\'s architectural character and market positioning among buyers who seek period homes. We provide comparative cost analysis over a 50-year horizon that typically shows slate restoration as the more economical choice.'
    },
    {
      question: 'Can you match the original slate on my Livingston roof?',
      answer: 'We source replacement slate from quarries matching the geological formation of your original installation and work with salvage suppliers who carry weathered slate from comparable buildings. An exact match to century-old weathered slate is rarely achievable, so we place replacement slates strategically in less visible locations and blend them into the field to minimize visual contrast. Over time, new slate weathers to more closely match the surrounding original material.'
    },
    {
      question: 'How long does a slate roof restoration take on a Livingston home?',
      answer: 'A full slate roof restoration on a Livingston home typically requires three to six weeks depending on the roof size, the proportion of slate requiring replacement, and the extent of structural repair discovered during the work. Selective repairs addressing specific damaged areas can complete in one to two weeks. We provide a detailed timeline during the assessment phase that accounts for material sourcing lead times for replacement slate.'
    },
    {
