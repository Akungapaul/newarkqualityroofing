...
export const livingstonRoofFlashingInstallationRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'How do I know if the flashing on my Livingston split-level needs replacement?',
      answer: 'Interior water stains at wall-roof intersections, damp spots in wall cavities detected during renovation work, and visible rust bleeding at flashing edges are all indicators. However, many flashing failures on split-levels produce no visible exterior symptoms because the water travels within the wall cavity before emerging at a distant location. We recommend flashing inspection during any roof work and as part of a home maintenance program for homes over 20 years old.'
    },
    {
      question: 'Should I upgrade to copper flashing during my Livingston roof replacement?',
