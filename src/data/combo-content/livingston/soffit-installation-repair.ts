...
export const livingstonSoffitInstallationRepair: ComboContent = {
  ...
  cityId: 'livingston',
  overview: [
    'Soffit panels beneath Livingston roof overhangs provide the critical ventilation intake that makes the entire attic airflow system function. When soffits are blocked, damaged, or inadequately vented, the attic overheats in summer accelerating shingle aging from below, traps moisture in winter promoting mold growth and wood rot, and fails to deliver the intake air volume that ridge vents need to create effective exhaust flow. On Livingston\'s split-level homes where ventilation engineering is already compromised by compartmentalized attic spaces, soffit performance is especially consequential.',
