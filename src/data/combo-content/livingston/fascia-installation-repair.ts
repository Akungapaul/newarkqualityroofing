...
export const livingstonFasciaInstallationRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'How do I know if my Livingston home\'s fascia needs replacement?',
