...
export const roselandInfraredRoofLeakDetection: ComboContent = {
  ...
  faqs: [
    {
      ...
      answer: 'Infrared cameras detect temperature differences across the roof surface. Wet insulation beneath the membrane retains solar heat longer than dry insulation, creating warmer zones visible in the thermal image during evening cooling. These warm zones correspond to moisture presence in the roof assembly, and their pattern reveals the path water has taken from the entry point outward. Physical core testing confirms the moisture condition at each thermal anomaly.'
    },
    {
      question: 'Is infrared detection more cost-effective than exploratory cutting?',
      answer: 'Significantly more cost-effective. Infrared detection surveys the full roof surface non-destructively in hours, while exploratory cutting requires sequential opening and patching of the membrane at multiple locations to locate the source -- each cut requiring repair afterward. The detection survey cost is typically recovered many times over through the reduced repair scope that precise diagnosis enables.'
    },
    {
      question: 'Can you detect leaks during rainy weather?',
      answer: 'Infrared surveys require dry conditions with clear skies for accurate results because rain on the roof surface creates uniform cooling that masks the thermal differences between wet and dry zones beneath. We schedule surveys during the optimal weather window following the rain event. For active leaks requiring immediate attention, we deploy temporary containment at the interior drip location and schedule the infrared survey for the first available optimal-condition evening.'
    },
    {
