...
export const roselandWindDamageRoofRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'I found shingles in my Roseland yard after a windstorm. How urgent is repair?',
      answer: 'Urgent. Missing shingles expose underlayment to direct weather contact, and the next rain event will test whether the remaining water barrier can prevent interior moisture intrusion. If underlayment is visible, schedule repair within days. If bare decking is exposed, emergency tarping is needed immediately. Even if no rain is imminent, exposed underlayment deteriorates rapidly under UV exposure, so delay converts a straightforward shingle replacement into a more involved repair that includes underlayment replacement and possible decking assessment.'
    },
    {
      question: 'Does insurance cover wind damage repair on my Roseland home?',
      answer: 'Yes, wind damage is covered under the windstorm peril in standard homeowner policies. Your responsibility is the policy deductible, which may be a flat amount or a percentage of dwelling coverage depending on your policy structure. We document wind damage with date-specific evidence, damage measurements, and repair specifications formatted for insurance submission. We can coordinate directly with your adjuster during the damage assessment to ensure complete coverage of all wind-related conditions.'
    },
    {
      question: 'Can wind damage affect my Roseland roof even if no shingles are visibly missing?',
      answer: 'Absolutely. Wind can lift and reseat shingle tabs, breaking the adhesive bond without physically displacing the shingle. These compromised shingles appear normal from the ground but have no wind resistance for future events and may allow water infiltration during wind-driven rain. Professional inspection after high-wind events checks adhesive bond integrity by hand-testing shingle tabs across exposed slopes. This is damage that only roof-level inspection can detect.'
    },
    {
