...
export const roselandSprayFoamRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'How long does spray foam roofing last on a Roseland commercial building?',
      answer: 'The SPF substrate itself lasts indefinitely when properly coated and maintained. The protective coating requires reapplication every 10 to 15 years for silicone systems or 5 to 8 years for acrylic systems. Each recoating renews the weathering surface and extends the system life without disturbing the foam beneath. Total system life of 30 to 50 years is achievable with scheduled recoating, making SPF one of the longest-lasting commercial roofing options when properly maintained.'
    },
    {
      question: 'Can spray foam be applied over our existing roof without tear-off?',
      answer: 'Yes, SPF recover application over existing roofing is the material\'s most compelling advantage. The foam adheres directly to clean, dry existing membranes including EPDM, TPO, PVC, BUR, and metal. This eliminates tear-off cost, construction debris, and the noise disruption that occupied Roseland office buildings cannot tolerate. The only requirement is that the existing system be dry -- moisture testing confirms suitability before proceeding.'
    },
    {
      question: 'Does spray foam roofing provide good insulation?',
      answer: 'SPF provides outstanding insulation at R-6.5 per inch of applied thickness, and the seamless application eliminates the thermal bridging that reduces effective R-value in board insulation systems. A typical 2-inch application adds R-13 insulation with zero gaps or joints. For Roseland commercial buildings with original insulation below current code requirements, SPF recover simultaneously solves the waterproofing and insulation deficiency in a single application.'
    },
    {
