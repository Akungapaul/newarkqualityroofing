...
export const maplewoodChimneyFlashingRepair: ComboContent = {
  serviceId: 'chimney-flashing-repair',
  cityId: 'maplewood',
  overview: [
    'Chimney flashing repair ranks among the most frequent roofing service calls in Maplewood, where nearly every Victorian, Colonial Revival, and Tudor home features at least one masonry chimney requiring the precise waterproofing interface between brick and roofing material. The original chimney flashing on homes built between 1890 and 1950 used galvanized steel embedded in mortar joints that have deteriorated over decades of freeze-thaw cycling. Our [chimney flashing repair](/chimney-flashing-repair) work in [Maplewood](/roofing-in-maplewood-nj) replaces these failing systems with modern materials that maintain waterproof integrity through the thermal movement that Maplewood\'s four-season climate imposes on every chimney-to-roof junction.',
  ...
  faqs: [
    {
      question: 'How often does chimney flashing need replacement on Maplewood homes?',
      answer: 'Quality chimney flashing with copper counter-flashing and proper mortar integration lasts 25-30 years before needing replacement. Galvanized steel flashing, which was standard on most original Maplewood installations, corrodes faster and typically needs replacement after 15-20 years. Sealant-only repairs last 2-5 years and should be considered temporary measures until proper flashing replacement can be scheduled.',
    },
    {
      question: 'My chimney leaks only during heavy rain. Is it the flashing?',
      answer: 'Heavy-rain-only leaks around chimneys typically indicate counter-flashing separation from mortar joints or deteriorated step flashing that allows water entry only when volume overwhelms compromised details. Light rain may not generate enough water flow to penetrate partial failures. We inspect during dry conditions to identify the specific failure point and provide targeted repair rather than blanket sealant application.',
    },
    {
      question: 'Do you repair the chimney masonry along with the flashing in Maplewood?',
      answer: 'We tuck-point deteriorated mortar joints and repair damaged brick as part of chimney flashing projects when masonry condition warrants it. Sound masonry is essential for counter-flashing performance. However, we are not chimney rebuild specialists. If the chimney requires structural rebuilding above the roofline, we coordinate with masonry contractors and schedule our flashing work to follow their structural repairs.',
    },
  ],
  metaDescription: 'Chimney flashing repair in Maplewood NJ. Expert step and counter-flashing for Victorian and Colonial masonry chimneys.',
};
