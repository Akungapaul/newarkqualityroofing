...
export const bellevilleAgingRoofReplacement: ComboContent = {
  ...
  cityId: 'belleville',
  overview: [
    'Aging roof replacement in Belleville addresses the largest segment of the township\'s residential roofing market: homes where the existing roof has simply reached the end of its service life through normal wear rather than catastrophic damage. The three-tab shingles installed on Belleville homes during the 1990s and early 2000s re-roofing cycle are now 20-30 years old -- at or beyond their designed lifespan. These roofs show progressive granule loss, curling at shingle edges, cracked tabs, and compromised waterproofing that worsens with each season.',
