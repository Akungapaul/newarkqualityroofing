...
export const bellevilleRoofIceDamPrevention: ComboContent = {
  ...
  faqs: [
    {
      question: 'Why do so many Belleville homes get ice dams?',
      answer: 'Belleville\'s post-war housing stock was built with minimal attic insulation -- typically R-11 to R-13, far below the current R-49 standard. This inadequate insulation allows interior heat to warm the roof deck, melting snow that refreezes at the cold eaves. The tight spacing between Belleville homes also creates wind patterns that deposit snow unevenly and reduce airflow across roof surfaces, compounding the problem.'
    },
    {
      question: 'Are heat cables a permanent solution for ice dams in Belleville?',
      answer: 'No. Heat cables treat the symptom (ice at the eaves) without addressing the cause (heat loss through the ceiling). They consume significant electricity, require maintenance, and only protect the specific areas where they are installed. We use heat cables as a supplementary measure for unavoidable ice accumulation zones, but the permanent solution is always insulation upgrade to R-49 and proper ventilation from eave to ridge.'
    },
    {
      question: 'How much does ice dam prevention cost for a Belleville Cape Cod?',
      answer: 'A comprehensive prevention package for a typical Belleville Cape Cod -- including air sealing, insulation upgrade to R-49, ventilation improvement, and ice-and-water shield installation -- typically costs $8,000-$15,000. This is comparable to the cost of repairing ice dam water damage from a single severe winter event, and it permanently eliminates the recurring damage that makes insurance claims increasingly difficult to file.'
    },
    {
      question: 'Will ice dam prevention reduce my heating bills in Belleville?',
      answer: 'Yes. The insulation and air-sealing improvements that prevent ice dams also reduce heating costs by 15-30% in Belleville\'s under-insulated post-war homes. The energy savings alone can recover a significant portion of the prevention investment within 5-7 years, making the project financially beneficial even before accounting for the eliminated repair costs and insurance complications that ice dams produce.'
    },
    {
