...
export const southOrangeModifiedBitumenRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'Is modified bitumen a good choice for my South Orange commercial building?',
      answer: 'Modified bitumen is well-suited for South Orange commercial buildings where redundant waterproofing, walkability, and repairability matter. The multi-layer construction provides backup protection that single-ply membranes cannot match, and the surface withstands regular foot traffic for maintenance access. For buildings where energy efficiency is the primary concern, TPO may offer better thermal performance. We evaluate each building and recommend the system that best addresses the specific priorities.'
    },
    {
      question: 'How long does modified bitumen roofing last in South Orange?',
      answer: 'A properly installed modified bitumen system with regular maintenance provides 20-25 years of service in the northern New Jersey climate. The multi-layer construction provides inherent redundancy -- if the cap sheet is damaged, the interply and base sheets continue to waterproof. Regular maintenance including debris clearing, drain inspection, and periodic reflective coating renewal helps modified bitumen systems reach the upper end of their expected service life.'
    },
    {
      question: 'What is the difference between torch-applied and self-adhered modified bitumen?',
      answer: 'Torch-applied installation uses an open flame to melt the underside adhesive of each ply, creating the strongest possible interply bond. Self-adhered sheets use factory-applied adhesive activated by peeling a release liner, eliminating fire risk during installation. Both methods produce a fully functional roof system, but torch application provides superior wind uplift resistance. We use self-adhered methods on occupied buildings and torch application where building conditions allow safe open-flame work.'
    },
    {
