...
export const southOrangeSprayFoamRoofing: ComboContent = {
  ...
  faqs: [
    {
      question: 'Can spray foam roofing be applied over my existing flat roof in South Orange?',
      answer: 'In many cases, yes. Spray foam recover installations can be applied over existing membrane, metal, or built-up roofing substrates if the existing material is well-adhered, dry, and structurally sound. The foam bonds directly to the existing surface, adding waterproofing and insulation without the cost and disruption of tear-off. If moisture testing reveals wet insulation or the substrate has adhesion problems, partial or complete tear-off may be necessary before foam application.'
    },
    {
      question: 'How long does a spray foam roof last in the South Orange climate?',
      answer: 'The spray foam itself is extremely durable and can last 30 or more years. The limiting factor is the protective coating that must be renewed periodically to shield the foam from UV degradation. With coating renewals at the recommended intervals -- typically every five to seven years -- the complete spray foam system provides decades of service. Neglecting coating maintenance exposes the foam to UV damage that progressively undermines the system.'
    },
    {
      question: 'How energy efficient is spray foam roofing compared to other commercial systems?',
      answer: 'Spray foam provides the highest insulation value per inch of any commercial roofing system. The continuous, seamless application eliminates the thermal bridging at fasteners and board joints that reduces the effective R-value of rigid insulation systems. For South Orange commercial buildings where energy efficiency matters both for cost savings and environmental values, spray foam delivers measurable reduction in heating and cooling energy consumption.'
    },
    {
