...
export const orangeSkylightInstallationRepair: ComboContent = {
  ...
  faqs: [
    {
      question: 'Will a skylight leak on my Orange home?',
      answer: 'Not if properly installed. Modern skylight flashing systems with stepped and woven details are engineered to be watertight for the skylight\'s entire 20 to 30-year lifespan. The leaks that Orange homeowners associate with skylights are typically caused by outdated pan-flashing installations from the 1980s and 1990s. Current installation methods eliminate those failure modes.'
    },
    {
      question: 'How do I keep a skylight clean near South Mountain?',
      answer: 'We recommend self-cleaning glass coatings that use UV light to break down organic deposits and allow rain to sheet off the surface cleanly. For skylights in heavy tree canopy zones, an annual professional cleaning removes accumulated debris and checks the flashing condition. Fixed skylights are easier to maintain than operable units because they have fewer hardware components exposed to debris.'
    },
    {
      question: 'Can I add a skylight to my Orange Victorian without changing the roofline?',
