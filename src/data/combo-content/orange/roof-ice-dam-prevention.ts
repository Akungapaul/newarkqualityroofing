...
export const orangeRoofIceDamPrevention: ComboContent = {
  ...
  faqs: [
    {
      question: 'Why are ice dams worse in Orange than in surrounding communities?',
      answer: 'South Mountain creates localized freezing conditions that deposit heavier ice accumulation on hillside Orange neighborhoods compared to flatland areas. Combined with the city\'s older housing stock that has inadequate insulation and ventilation, Orange experiences more severe and frequent ice dam formation than neighboring communities at lower elevation. The mountain terrain amplifies the basic physics of ice dam formation.'
    },
    {
      question: 'Do heat cables solve ice dam problems on Orange homes?',
      answer: 'Heat cables treat the symptom rather than the cause. They melt channels through existing ice dams to release trapped water, but they consume significant electricity, require maintenance, and do not prevent ice dam formation. We recommend heat cables only as a supplemental measure at specific vulnerable locations after addressing the root causes -- air sealing, insulation, and ventilation improvements that prevent ice dams from forming in the first place.'
    },
    {
      question: 'How much does ice dam prevention cost for a typical Orange home?',
      answer: 'A comprehensive prevention program for a typical Orange colonial -- air sealing, insulation upgrade to R-49, and ventilation improvement -- typically runs $3,000 to $6,000. Victorian homes with complex rooflines and multiple problem zones may run $5,000 to $10,000. These costs are offset by reduced winter heating bills, eliminated ice dam repair costs, and prevented interior water damage that can cost thousands per incident.'
    },
    {
